...
idxs=[[(1,2,3,4),(0,1,4,5),(0,2,3,5)],[(1,2,3,4,size_a+1,size_a+2,size_a+3,size_a+4,),(0,1,4,5,size_a,size_a+1,size_a+4,size_a+5),(0,2,3,5,size_a,size_a+2,size_a+3,size_a+5)]]
...
np.savez('data/quantum_annealing_results/different_states_quantum_annealing',fidelity=npart_fidelities,errors=npart_errors,particles=nparts,labels=labels)
